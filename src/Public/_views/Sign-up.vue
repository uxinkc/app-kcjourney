          ...
          <div class="ds-login">
            <div class="fds-m-t--xl@m fds-shadow--raised fds-p--m fds-p--l@m">
              ...
              <div class="fds-field fds-field--fill">
                ...
                <input v-model="password" v-on:keyup.enter="signup()" class="fds-input fds-field__item" :id="passwordId" :aria-describedby="passwordId+'-help'" aria-required="true" :name="passwordId" :type="isPasswordVisible?'text':'password'">
